...
contract BenchmarkController is Ownable {
    ...
    uint256 public fundingAmount = 1e18;
    uint256 public seedAmount = 10e18;
    ...
    function requestCertificationRun(uint256 agentId) external payable returns (uint256 runId) {
        ...
        // Mint seed tokens to the operator so they can seed exploits (e.g., reentrancy deposit)
        benchmarkToken.mint(agent.operator, seedAmount);
