...
contract BenchmarkControllerTest is Test {
    ...
    function test_requestCertificationRun_mintsSeedTokensToOperator() public {
        ...
        // Operator should receive seed tokens for exploit seeding
        assertGt(token.balanceOf(operator), 0);
        assertEq(token.balanceOf(operator), controller.seedAmount());
    }
